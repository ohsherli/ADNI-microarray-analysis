...
```{r}
(adni_diagnosis_metadata_raw %>% split(adni_diagnosis_metadata_raw$PTID))[[1]]
```
...
```{r}
# import csv for age
ADNI_mRNA_Age <- read.csv("~/Desktop/NTU/EG_Lab/data/ADNI_raw_files/ADNI_mRNA_Age.csv")
ADNI_mRNA_Age %>% head

# import csv for gender
ADNIMERGE <- read.csv("~/Desktop/NTU/EG_Lab/data/ADNI_raw_files/Data___Database/ADNIMERGE.csv")

# import csv for MMSE scores


# import csv for APOE genotyping
APOERES <- read.csv("~/Desktop/NTU/EG_Lab/data/ADNI_raw_files/Biospecimen_Results/APOERES.csv")
```
